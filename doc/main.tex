...
\usepackage{fancyhdr} % An extended support for fancy headers and footers
    ...
    \fancyhf[roh]{\textit{Ten Kingdoms: Ancient Adversaries}}
...
Ten Kingdoms: Ancient Adversaries OSS Project} % Do not change.
...
\textswab{\huge{I}}n 2009, Trevor Chan from Enlight Software released the source code for \textit{Ten Kingdoms: Ancient Adversaries}. He released it under a community project so that developers can provide some long awaited bug fixes and address some other game-play issues.
